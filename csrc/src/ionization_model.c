...
/* Na: Z=1..11 */
static const double E_Na[] = {
    5.13907696, 47.28636, 71.6200, 98.936, 138.404, 172.23, 208.504, 264.192, 299.856, 1465.0992, 1648.702285};

/* Rb: Z=1..37 */
static const double E_Rb[] = {
    4.1771281, 27.28954, 39.247, 52.20, 68.44, 82.9, 98.67, 132.79, 150.628,
    277.12, 313.1, 356.0, 400, 443, 502, 550, 601, 654, 706.0, 857, 905.3,
    958.9, 1024, 1080, 1125, 1242.5, 1294.57, 3133.3, 3281, 3443, 3600, 3815,
    3988, 4214, 4356.865, 18305.886, 18965.5484};

/* Be: Z=1..4 */
static const double E_Be[] = {
    9.322699, 18.21115, 153.896205, 217.71858459};
...
static const IonSpeciesTable *find_species(const char *species)
{
    ...
    {
        if (strcmp(species, ION_TABLES[i].name) == 0)
            return &ION_TABLES[i];
    }
    return NULL;
}
...
double ADK_scalar_rate(double E_abs, double ion_ene_eV, int Z)
{
    ...
    double A = 1.52 * pow(4.0, n) * ion_ene_eV * pow(20.5 * pow(ion_ene_eV, 1.5), C) / (n * tgamma(2.0 * n));
